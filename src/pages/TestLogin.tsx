    ...
    <>
      <div className="min-h-screen bg-gradient-to-r from-slate-900 to-indigo-900">
        ...
        <div className="flex flex-row justify-between">
          <div className="pt-20 flex flex-col pl-24">
            <span className="text-3xl font-ubuntu font-bold text-gray-400 py-4">
              DSA Buddy
            </span>
            <span className="font-ubuntu text-6xl font-bold text-[#8CCBEF]">
              Login to CP-Diary
            </span>
            <span className=" font-ubuntu text-xl text-blue-300 py-6">
              Create new Account
            </span>
            <form>
            ...
            <div className="flex flex-row gap-x-4 items-center">
              <button className="bg-[#EF087A] w-fit font-roboto text-lg px-8 py-2 mt-8 text-white font-bold rounded-xl">
                Login
              </button>
              <span className="text-xl font-ubuntu text-blue-300 mt-8">
                Forgot Password?
              </span>
            </div>
          </div>
        ...
        <div className="h-20 bg-slate-900 mb-0 bottom-0 fixed w-full shadow-md">
          <div className="flex flex-row items-center justify-center">
            <div className="flex flex-col justify-center items-center">
              <span className="text-white font-roboto font-bold text-lg pt-2">
                Developed with ❤️
              </span>
